...
class ClassUtDba(unittest.TestCase):
    ...
    def tc_dba_cebs_001(self):
        ...
        jsonInputData = {"restTag": "dba", "actionId": 0X0ED7, "parFlag": 1, "parContent": {'cmd': 'add', 'uid': 250,
                                                                                            'login_name': 'admin', 'pass_word': '13456', 'grade_level': 1, 'email': '13525@.com', 'memo': 'this'}}
        result = ModTestSuitComFunc.hst_curlib3_client_connection(
            jsonInputData, 1)
    ...
    def tc_dba_cebs_005(self):
        ...
        jsonInputData = {"restTag": "dba", "actionId": 0X0ED9, "parFlag": 7, 'parContent': {
            'cmd': 'add', 'platetype': 1, 'left_bot_x': 19, 'left_bot_y': 19, 'right_up_x': 19, 'right_up_y': 19}}
        ...
        jsonInputData1 = '{"restTag": "dba","actionId": 3801,"parFlag": 1,"parContent" : {"cmd": "read", "id":' + \
            str(newId) + '}}'
        # print(jsonInputData)
        result = ModTestSuitComFunc.hst_curlib3_client_connection(
            jsonInputData1, 1)
        ...
        for item in subdict:
            if item != "calitime":
                if subdict[item] != jsonInputData['parContent'][item]:
                    ...
                    print("Test data " + jsonInputData['parContent'][
                          item] + " is not equal database data " + subdict[item])
                    break
    ...
    def tc_dba_cebs_006(self):
        ...
        #jsonInputData = {"restTag": "dba","actionId": 0X0ED9,"parFlag": 7,"parContent": {"cmd": "add", "platetype": 1, "uid": "UID3982146", "left_bot_x": 9, "left_bot_y": 9, "right_up_x": 9, "right_up_y": 9}}
        jsonInputData = {"restTag": "dba", "actionId": 0X0EDA, "parFlag": 7, 'parContent': {'cmd': 'add', 'objname': 'xianchong',
                                                                                            'objtype': 1, 'dir_origin': '/var/www/origin', 'dir_middle': '/var/www/middle', 'memo': 'varcebs', 'defaultflag': 0}}
        jsonInputData['parContent'].update({"uid": uid})
        ...
        jsonInputData1 = '{"restTag": "dba","actionId": 3802,"parFlag": 1,"parContent" : {"cmd": "read", "objid":' + \
            str(newId) + '}}'
        # print(jsonInputData)
        result = ModTestSuitComFunc.hst_curlib3_client_connection(
            jsonInputData1, 1)
    ...
    def tc_dba_cebs_007(self):
        ...
        #jsonInputData = {"restTag": "dba","actionId": 0X0ED9,"parFlag": 7,"parContent": {"cmd": "add", "platetype": 1, "uid": "UID3982146", "left_bot_x": 9, "left_bot_y": 9, "right_up_x": 9, "right_up_y": 9}}
        jsonInputData = {"restTag": "dba", "actionId": 0X0EDB, "parFlag": 7, 'parContent': {'cmd': 'add', 'fixpoint': 0, 'autovideo': 0, 'autodist': 0, 'addset': 1, 'autocap': 0, 'autoperiod': 60,
                                                                                            'videotime': 3, 'slimit': 200, 'smlimit': 500, 'mblimit': 2000, 'blimit': 5000, 'accspeed': 20, 'decspeed': 20, 'movespeed': 20, 'zero_spd': 20, 'zero_dec': 20, 'back_step': 12800}}
        ...
        jsonInputData1 = '{"restTag": "dba","actionId": 3803,"parFlag": 1,"parContent" : {"cmd": "read", "confid":' + \
            str(newId) + '}}'
        # print(jsonInputData)
        result = ModTestSuitComFunc.hst_curlib3_client_connection(
            jsonInputData1, 1)
    ...
    def tc_dba_cebs_008(self):
        ...
        #jsonInputData = {"restTag": "dba","actionId": 0X0ED9,"parFlag": 7,"parContent": {"cmd": "add", "platetype": 1, "uid": "UID3982146", "left_bot_x": 9, "left_bot_y": 9, "right_up_x": 9, "right_up_y": 9}}
        jsonInputData = {"restTag": "dba", "actionId": 0X0ED9, "parFlag": 7, 'parContent': {
            'cmd': 'modify', 'platetype': 1, 'left_bot_x': 29, 'left_bot_y': 29, 'right_up_x': 29, 'right_up_y': 29}}
        jsonInputData['parContent'].update({"id": calid})
            ...
            if item != "uid" and item != "calitime":
                if subdict[item] != jsonInputData['parContent'][item]:
                    ...
                    print("Test data " + jsonInputData['parContent'][
                          item] + " is not equal database data " + subdict[item])
                    break
        print("test tc_dba_cebs_008 result is " + testResult)
    ...
    def tc_dba_cebs_009(self):
        ...
        #jsonInputData = {"restTag": "dba","actionId": 0X0ED9,"parFlag": 7,"parContent": {"cmd": "add", "platetype": 1, "uid": "UID3982146", "left_bot_x": 9, "left_bot_y": 9, "right_up_x": 9, "right_up_y": 9}}
        jsonInputData = {"restTag": "dba", "actionId": 0X0EDA, "parFlag": 7, 'parContent': {'cmd': 'modify', 'objname': 'fish',
                                                                                            'objtype': 2, 'dir_origin': '/var/www/origin1', 'dir_middle': '/var/www/middle1', 'memo': 'varcebs1', 'defaultflag': 0}}
        jsonInputData['parContent'].update({"objid": objid})
            ...
            if item != "uid":
                if subdict[item] != jsonInputData['parContent'][item]:
                    ...
                    print("Test data " + jsonInputData['parContent'][
                          item] + " is not equal database data " + subdict[item])
                    break
        print("test tc_dba_cebs_009 result is " + testResult)

    def tc_dba_cebs_010(self):
        ticks = time.time()

        print("tc_dba_cebs_010, time in second = ", ticks)
        confid = models.t_cebs_config_eleg.objects.all().last().confid

        #jsonInputData = {"restTag": "dba","actionId": 0X0ED9,"parFlag": 7,"parContent": {"cmd": "add", "platetype": 1, "uid": "UID3982146", "left_bot_x": 9, "left_bot_y": 9, "right_up_x": 9, "right_up_y": 9}}
        jsonInputData = {"restTag": "dba", "actionId": 0X0EDB, "parFlag": 7, 'parContent': {'cmd': 'modify', 'fixpoint': 1, 'autovideo': 1, 'autodist': 1, 'addset': 1, 'autocap': 0, 'autoperiod': 60,
                                                                                            'videotime': 3, 'slimit': 200, 'smlimit': 500, 'mblimit': 2000, 'blimit': 5000, 'accspeed': 120, 'decspeed': 120, 'movespeed': 120, 'zero_spd': 120, 'zero_dec': 120, 'back_step': 12800}}
        jsonInputData['parContent'].update({"confid": confid})
...
# add a new init configuration record and read init configuration
    def tc_dba_cebs_011(self):
        ...
        userid = newId = models.t_cebs_user_sheet.objects.all().last().uid
        #jsonInputData = {"restTag": "dba","actionId": 0X0ED9,"parFlag": 7,"parContent": {"cmd": "add", "platetype": 1, "uid": "UID3982146", "left_bot_x": 9, "left_bot_y": 9, "right_up_x": 9, "right_up_y": 9}}
        jsonInputData = {"restTag": "dba", "actionId": 0X0EDF, "parFlag": 7, 'parContent': {'cmd': 'add', 'defaultflag': True, 'memo': 'add test', 'calitime': '2019-04-21 04:14:22.249304', 'uid': userid, 'caliuid': userid, 'objname': 'objtest0422add', 'objtype': 5, 'dir_origin': '/www/abcadd', 'dir_middle': '/var/t0add', 'fixpoint': True, 'autovideo': True,
                                                                                            'autodist': True, 'addset': True, 'autocap': True, 'autoperiod': 4220, 'videotime': 4220, 'slimit': 220, 'smlimit': 220, 'mblimit': 220, 'blimit': 220, 'accspeed': 40, 'decspeed': 220, 'movespeed': 40, 'zero_spd': 220, 'zero_dec': 40, 'back_step': 220, 'platetype': 1, 'left_bot_x': 40, 'left_bot_y': 220, 'right_up_x': 40, 'right_up_y': 220}}
...
#         pass
    ...
    def tc_dba_faam_001(self):
        ...
        jsonInputData = {"restTag": "dba", "actionId": 4128, "parFlag": 1, "parContent": {
            "cmd": "add", "caption": "TEST111", "ctime": "12345", "uptime": "12131414", "userId": "111"}}
        ModTestSuitComFunc.hst_curlib3_client_connection(jsonInputData, 1)
        pass
