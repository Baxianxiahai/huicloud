...
class ClassUtVision(unittest.TestCase):
    ...
    def tc_vision_002(self):
        ...
        jsonInputData = {"restTag": "vision","actionId": 3001,"parFlag": 1,"parContent": {"sn": 55,"sucFlag": 1,"errCode": 0}}
    ...
    def tc_vision_003(self):
        ...
        jsonInputData = {"restTag": "vision","actionId": 3002,"parFlag": 1,"parContent": {"sn": 55,"sucFlag": 1,"errCode": 0}}
    ...
    def tc_vision_004(self):
        ...
        jsonInputData = {"restTag": "vision","actionId": 3003,"parFlag": 1,"parContent": {"sn": 55,"sucFlag": 1,"errCode": 0}}
        ModTestSuitComFunc.hst_curlib3_client_connection(self, jsonInputData, 1)        
    ...
    def tc_vision_005(self):
        ...
        jsonInputData = {"restTag": "vision","actionId": 3004,"parFlag": 1,"parContent": {"fileName":"11.JPG", "cfBase":600, "cfSmall2MidIndex":1500, "cfMid2BigIndex":2500, "cfBig2TopIndex":5000}}
        res = ModTestSuitComFunc.hst_curlib3_client_conn_check_details(self, jsonInputData, 1)     
        if (res['totalNbr']) > 0:
            print("tc_vision_005: Total classified number = ", res['totalNbr'])
        else:
    ...
    def tc_vision_006(self):
        ...
        jsonInputData = {"restTag": "vision","actionId": 3004,"parFlag": 1,"parContent": {"fileName":"12.JPG", "cfBase":500, "cfSmall2MidIndex":1500, "cfMid2BigIndex":2500, "cfBig2TopIndex":3500}}
        res = ModTestSuitComFunc.hst_curlib3_client_conn_check_details(self, jsonInputData, 1)     
        if (res['totalNbr']) > 0:
    ...
    def tc_vision_007(self):
        ...
        jsonInputData = {"restTag": "vision","actionId": 3004,"parFlag": 1,"parContent": {"fileName":"3.JPG", "cfBase":500, "cfSmall2MidIndex":1500, "cfMid2BigIndex":2500, "cfBig2TopIndex":3500}}
        res = ModTestSuitComFunc.hst_curlib3_client_conn_check_details(self, jsonInputData, 1)     
        if (res['totalNbr']) > 0:
    ...
    def tc_vision_008(self):
        ...
        jsonInputData = {"restTag": "vision","actionId": 3004,"parFlag": 1,"parContent": {"fileName":"4.JPG", "cfBase":500, "cfSmall2MidIndex":1500, "cfMid2BigIndex":2500, "cfBig2TopIndex":3500}}
        res = ModTestSuitComFunc.hst_curlib3_client_conn_check_details(self, jsonInputData, 1)     
        if (res['totalNbr']) > 0:
    ...
    def tc_vision_009(self):
        ...
        jsonInputData = {"restTag": "vision","actionId": 3004,"parFlag": 1,"parContent": {"fileName":"5.JPG", "cfBase":500, "cfSmall2MidIndex":1500, "cfMid2BigIndex":2500, "cfBig2TopIndex":3500}}
        res = ModTestSuitComFunc.hst_curlib3_client_conn_check_details(self, jsonInputData, 1)     
        if (res['totalNbr']) > 0:
