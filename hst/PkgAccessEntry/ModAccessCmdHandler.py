...
class ClassHuirestDbaInputCmdHandler:
    ...
    __HUIREST_ACTIONID_DBA_COMM                     = 0X1000
    ...
    __HUIREST_ACTIONID_DBA_AQYC                     = 0X1000
    __HUIREST_ACTIONID_DBA_BFDF                     = 0X1000
    __HUIREST_ACTIONID_DBA_BFHS                     = 0X1000
    __HUIREST_ACTIONID_DBA_CCL                      = 0X1000
    __HUIREST_ACTIONID_DBA_CEBS_env                 = 0X1000
    __HUIREST_ACTIONID_DBA_CEBS_counter             = 0X1000
    __HUIREST_ACTIONID_DBA_CEBS_fspc                = 0X1000
    __HUIREST_ACTIONID_DBA_CEBS_file                = 0X1000
    __HUIREST_ACTIONID_DBA_FAAM                     = 0X1000
    __HUIREST_ACTIONID_DBA_FSTT                     = 0X1000
    __HUIREST_ACTIONID_DBA_TEST                     = 0X1000
